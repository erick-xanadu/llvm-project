...
// CHECK: linalg.yield
  ...
  func.func @transformtrunci (%arg0: tensor<4x4xi64>) -> tensor<4x4xi32> {
// CHECK: linalg.init_tensor
// CHECK: linalg.generic
    %0 = arith.trunci %arg0 : tensor<4x4xi64> to tensor<4x4xi32>
// CHECK: %2 = arith.trunci %arg1 : i64 to i32
// CHECK: linalg.yield
    return %0 : tensor<4x4xi32>
  }

  func.func @transformuitofp (%arg0: tensor<4x4xi32>) -> tensor<4x4xf32> {
// CHECK: linalg.init_tensor
// CHECK: linalg.generic
    %0 = arith.uitofp %arg0 : tensor<4x4xi32> to tensor<4x4xf32>
// CHECK: %2 = arith.uitofp %arg1 : i32 to f32
// CHECK: linalg.yield
    return %0 : tensor<4x4xf32>
  }
